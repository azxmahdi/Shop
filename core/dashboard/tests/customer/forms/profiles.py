...
class CustomerChangePasswordFormTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        cls.form = CustomerChangePasswordForm(cls.valid_data)
    ...
    def test_change_password_form_with_invalid_data(self):
        ...
        form = CustomerChangePasswordForm(invalid_data)
...
class CustomerProfileEditFormTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.valid_data = {
            "delete_image": False,
        ...
        cls.form = CustomerProfileEditForm(cls.valid_data)
    ...
    def test_profile_edit_form_with_invalid_data(self):
        ...
        form = CustomerProfileEditForm(invalid_data)
        self.assertFalse(form.is_valid())
