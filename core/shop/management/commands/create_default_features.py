...
from shop.models import CategoryFeature, FeatureOption, ProductCategoryModel
...
class Command(BaseCommand):
    help = (
        "ایجاد داده‌های نمونه با ۱۴ ویژگی برای هر دسته (۷ اجباری + ۷ غیراجباری)"
    )
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "Default features for all categories were successfully created."
            )
        )
